...
class Achiev extends StatefulWidget {
  const Achiev({super.key});

  @override
  State<Achiev> createState() => _AchievState();
}

class _AchievState extends State<Achiev> {
  int i = 1;
  // String? ll;
  double hom = 2.3;
